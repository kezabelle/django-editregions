...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StylesheetAsset'
        db.create_table(u'embeds_stylesheetasset', (
            ...
            ('local', self.gf('django.db.models.fields.CharField')(max_length=2048, blank=True)),
            ('external', self.gf('django.db.models.fields.CharField')(max_length=2048, blank=True)),
        ))
        db.send_create_signal(u'embeds', ['StylesheetAsset'])

        # Adding model 'JavascriptAsset'
        db.create_table(u'embeds_javascriptasset', (
            (u'editregionchunk_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editregions.EditRegionChunk'], unique=True, primary_key=True)),
            ('local', self.gf('django.db.models.fields.CharField')(max_length=2048, blank=True)),
            ('external', self.gf('django.db.models.fields.CharField')(max_length=2048, blank=True)),
        ))
        db.send_create_signal(u'embeds', ['JavascriptAsset'])


    def backwards(self, orm):
        # Deleting model 'StylesheetAsset'
        db.delete_table(u'embeds_stylesheetasset')

        # Deleting model 'JavascriptAsset'
        db.delete_table(u'embeds_javascriptasset')
    ...
    models = {
        ...
        u'embeds.javascriptasset': {
            'Meta': {'ordering': "[u'position']", 'object_name': 'JavascriptAsset', '_ormbases': [u'editregions.EditRegionChunk']},
            u'editregionchunk_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['editregions.EditRegionChunk']", 'unique': 'True', 'primary_key': 'True'}),
            'external': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'}),
            'local': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'})
        },
        u'embeds.stylesheetasset': {
            'Meta': {'ordering': "[u'position']", 'object_name': 'StylesheetAsset', '_ormbases': [u'editregions.EditRegionChunk']},
            u'editregionchunk_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['editregions.EditRegionChunk']", 'unique': 'True', 'primary_key': 'True'}),
            'external': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'}),
            'local': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'})
        }
