...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('editregions_editregionchunk', (
            ...
            ('render_content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['contenttypes.ContentType'])),
        ))
    ...
    models = {
        ...
        'editregions.editregionchunk': {
            ...
            'render_content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['contenttypes.ContentType']"})
        }
    }
